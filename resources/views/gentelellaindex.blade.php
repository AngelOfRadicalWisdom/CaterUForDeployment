        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Cater U</span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-file-text"></i> Manage Menu <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="form_advanced.html">Add New Menu</a></li>
                      <li><a href="form_validation.html">Category List</a></li>
                      <li><a href="form_wizards.html">Add New Category</a></li>
                      <li><a href="form_upload.html">Add new SubCategory</a></li>
                      <li><a href="form_buttons.html">SubCategory List</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-users"></i> Manage Employees<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="form_advanced.html">Add New Employee</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-desktop"></i> Report<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="general_elements.html">Sales Report</a></li>
                    </ul>
                  </li>
                  <li href="#"><a><i class="fa fa-table"></i> Tables</a>
                  </li>
                  <li><a><i class="fa fa-random"></i>Recommendation<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="chartjs.html">Recommendation Settings</a></li>
                      <li><a href="chartjs2.html">Generate Recommendations</a></li>
                      <li><a href="morisjs.html">Create Bundled Menus</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
