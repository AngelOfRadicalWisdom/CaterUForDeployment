    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{ url('/employee/edit_employee/'.$employeeRecord->empid)}}" enctype="multipart/form-data">

              <div class="item form-group">
                <label class="col-form-label col-md-3 col-sm-3 label-align" for="empfirstname">First Name <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" class="form-control" name="empfirstname" placeholder="Employee Firstname" value="{{$employeeRecord->empfirstname}}" required="required">
                </div>
              </div>
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" class="form-control" name="emplastname" placeholder="Employee Lastname" value="{{ $employeeRecord->emplastname}}" required="required">
                </div>
              </div>
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" class="form-control" name="username" placeholder="Username" value="{{ $employeeRecord->username}}" required="required">
                </div>
              </div>
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 ">
                  <select name="position" class="form-control">
                    <option value="{{$employeeRecord->position}}">{{$employeeRecord->position}}</option>
                    @if($employeeRecord->position=='admin')
              ...
              <div class="item form-group">
                <div class="col-md-6 col-sm-6 offset-md-4">
                  ...
                  <button class="btn btn-danger" href="{{url('/employee/employeelist')}}">Cancel</button>
                </div>
              </div>
