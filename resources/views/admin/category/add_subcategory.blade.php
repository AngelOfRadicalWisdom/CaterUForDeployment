 ...
 <div class="right_col" role="main">
    ...
    <div class="alert alert-danger alert-dismissible " role="alert">
      ...
      @endif
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"  action="{{ url('/admin/add_subcategory')}}" method="post" name="add_category" id="add_subcategory">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" name="subname" required="required" class="form-control "value="{{ old('menuName')}}" placeholder="Enter Sub Category Name" required="required">
                        </div>
                      </div>
                      <div class="item form-group">
