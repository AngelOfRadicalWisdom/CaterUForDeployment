          ...
          @endif
                  <div class="x_content">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="item form-group">
                      <label class="col-form-label col-md-3 col-sm-3 label-align"><h4>Inclusive Menus:</h4>
                        </label>
                        <div class=" col-md-6 col-sm-6 ">
            ...
            <div class="ln_solid"></div>
                      <div class="item form-group">
                        ...
                        <button class="btn btn-primary" type="reset">Reset</button>
                          <button class="btn btn-danger" href="{{url('/promo/promolist')}}"  >Cancel</button>
                        </div>
                      </div>
                      </form>
                  </div>
...
//       title: 'Cancelled!',
//       text: 'Edit Promotion has been cancelled.',
//       icon: 'error',
